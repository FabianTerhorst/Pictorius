...
public class SimpleArrayadapter2 extends ArrayAdapter<String> {
  ...
  LayoutParams params;
  public SimpleArrayadapter2(Context context, String[] values, String[] values2, String[] values3, String[] values4, String[] values5, String[] values6) {
